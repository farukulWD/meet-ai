...
export const premiumProcedures = (entity: "agents" | "meetings") =>
  protectedProcedure.use(async ({ ctx, next }) => {
    ...
    if (shouldThrowMeetingError) {
      throw new TRPCError({
        code: "FORBIDDEN",
        message: "You reached the maximum number of free meetings",
      });
    }
    if (shouldThrowAgentError) {
      throw new TRPCError({
        code: "FORBIDDEN",
        message: "You reached the maximum number of free agents",
      });
    }
